...
/**
 * Provide simplecontact admin add/edit form
 */
class SimplecontactAdminForm extends FormBase {
    ...
    public function getFormId() {
        return 'simplecontact_adminform';
    }
    ...
    public function buildForm(array $form, FormStateInterface $form_state, $cid = NULL) {
        $this->cid = $cid;
        $item = ['firstname' => '', 'lastname' => '', 'email' => '', 'phonenumber' => '', 'country' => $this->contacts->defaultCountry, 'city' => '', 'street' => '', 'streetnumber' => '', 'zip' => '', 'status' => $this->contacts->defaultStatus];
        if ($this->cid) {
            $contact = $this->contacts->contactsGetItem($cid);
        ...
        $form['phonenumber'] = [
            ...
            '#maxlength' => 60,
            '#required' => TRUE,
            '#default_value' => $item['phonenumber'],
        ];
        ...
        $form['streetnumber'] = [
            ...
            '#maxlength' => 10,
            '#required' => TRUE,
            '#default_value' => $item['streetnumber'],
        ];
    ...
    public function validateForm(array &$form, FormStateInterface $form_state) {
        ...
        if (!empty($contact) && $this->cid != $contact->cid) {
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        if ($this->cid) {
            $this->contacts->contactsUpdate($fields, $this->cid);
            \Drupal::messenger()->addMessage('Contact updated successfully.');
        } else {
